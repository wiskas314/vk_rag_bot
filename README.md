# 🤖 VK Бот — Помощник по информатике

Бот для ВКонтакте, который анализирует код учеников и даёт **подсказки** (не готовые ответы).  
Использует **RAG систему** + **Ollama LLM** локально, без облачных API.
